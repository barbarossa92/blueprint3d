...
var TextureSelector = function (blueprint3d, sideMenu) {
  ...
  function initTextureSelectors() {
    ...
    function initChangeHeightWall() {
      $("#wall-height").change(function (e) {
          currentTarget.resizeWallHeight($("#wall-height").val());
          e.preventDefault();
      })
  }
  ...
  function wallClicked(halfEdge) {
    ...
    $("#wall-height").val(currentTarget.getWallHeight());
    $("#wallTextures").show();  
  }
